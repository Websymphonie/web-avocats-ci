...
{
    public function __construct(private PhotoGalleryRepositoryInterface $repository, private NewsRepositoryInterface $newsRepository, private EventRepositoryInterface $eventRepository) {}
    public function isUsed(int $mediaId): bool { return $this->repository->countMediaUsage($mediaId) > 0 || $this->newsRepository->countMediaUsage($mediaId) > 0 || $this->eventRepository->countMediaUsage($mediaId) > 0; }
}
