...
final class DemoContentFixtures extends Fixture implements FixtureGroupInterface, DependentFixtureInterface
{
    ...
    private function loadPages(ObjectManager $manager): void
    {
        ...
        foreach ($pages as $index => $definition) {
            ...
            $hasCover = $definition['hasCover'] ?? false;
            ...
            $content = isset($definition['contentKey'])
                ? $institutionalContents[$definition['contentKey']]
    ...
    private function loadInstitutionalPeople(ObjectManager $manager): void
    {
        ...
        $batonnierName = $batonnierData['fullName'];
        ...
        foreach (InstitutionalPageContent::councilMembers() as $index => $memberData) {
            ...
            $portraitReference = $memberData['portraitReference'];
