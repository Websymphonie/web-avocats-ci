...
final class GetNewsCategoryListController extends AbstractController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $form = $this->createForm(NewsCategoryFilterType::class, $query, ['method' => 'GET', 'action' => $this->generateUrl('content_admin_news_category_list')]); $form->handleRequest($request);
        return $this->render('content/admin/news_category/index.html.twig', ['categories' => $this->handleQuery(new GetNewsCategoryListQuery($query->search ?: null, $query->page, 20)), 'filterForm' => $form->createView()]);
    }
}
