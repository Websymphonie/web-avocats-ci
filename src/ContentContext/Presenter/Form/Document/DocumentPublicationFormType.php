...
final class DocumentPublicationFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->add('title', TextType::class, ['label' => 'Titre', 'attr' => ['placeholder' => 'Titre de la publication']])
            ...
            ->add('accessLevel', EnumType::class, ['label' => 'Niveau d’accès', 'class' => DocumentAccessLevel::class, 'choice_label' => static fn (DocumentAccessLevel $value): string => $value->label()])
