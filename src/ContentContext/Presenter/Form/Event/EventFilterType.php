...
/** @extends AbstractType<GetEventListQuery> */
final class EventFilterType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->add('search', TextType::class, ['label' => 'Rechercher', 'required' => false, 'attr' => ['placeholder' => 'Rechercher par titre']])
            ->add('status', EnumType::class, ['label' => 'Statut', 'class' => EventStatus::class, 'choice_label' => static fn (EventStatus $value): string => $value->label(), 'required' => false, 'placeholder' => 'Tous les statuts'])
            ->add('format', EnumType::class, ['label' => 'Format', 'class' => EventFormat::class, 'choice_label' => static fn (EventFormat $value): string => $value->label(), 'required' => false, 'placeholder' => 'Tous les formats'])
    ...
    public function configureOptions(OptionsResolver $resolver): void { $resolver->setDefaults(['data_class' => GetEventListQuery::class, 'method' => 'GET', 'csrf_protection' => false]); }
