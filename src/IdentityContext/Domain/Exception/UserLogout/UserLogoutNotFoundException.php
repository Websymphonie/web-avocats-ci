...
namespace Websymphonie\IdentityContext\Domain\Exception\UserLogout;

use DomainException;
use Websymphonie\IdentityContext\Domain\Exception\UserFacingError;

final class UserLogoutNotFoundException extends DomainException implements UserFacingError
{
