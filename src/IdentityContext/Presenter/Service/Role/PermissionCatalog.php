...
final class PermissionCatalog
{
    ...
    private static function group(PermissionEnum $permission): string
    {
        return match ($permission) {
            ...
            PermissionEnum::CONTENT_VIDEO_CATEGORY_VIEW,
            PermissionEnum::CONTENT_VIDEO_CATEGORY_MANAGE,
            PermissionEnum::CONTENT_VIDEO_CATEGORY_DELETE => 'Contenu · Catégories de vidéos éditoriales',
            ...
            PermissionEnum::BATONNIER_EDIT => 'Contenu · Bâtonnier',
            PermissionEnum::COUNCIL_MEMBER_LIST,
            PermissionEnum::COUNCIL_MEMBER_VIEW,
            PermissionEnum::COUNCIL_MEMBER_CREATE,
            PermissionEnum::COUNCIL_MEMBER_EDIT => 'Contenu · Conseil de l’Ordre',
            PermissionEnum::CABINET_VIEW,
            PermissionEnum::CABINET_CREATE,
            PermissionEnum::CABINET_EDIT => 'Profession · Cabinets',
