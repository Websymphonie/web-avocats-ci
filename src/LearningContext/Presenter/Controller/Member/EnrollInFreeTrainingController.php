...
final class EnrollInFreeTrainingController extends AbstractController
{
    ...
    {
        if (!$this->isCsrfTokenValid('learning_member_training_enroll_' . $uuid, (string) $request->request->get('_token'))) { throw $this->createAccessDeniedException('Jeton CSRF invalide.'); }
