...
/** @extends AbstractType<GetTrainingTagListQuery> */
final class TrainingTagFilterType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void { $resolver->setDefaults(['data_class' => GetTrainingTagListQuery::class, 'method' => 'GET', 'csrf_protection' => false]); }
