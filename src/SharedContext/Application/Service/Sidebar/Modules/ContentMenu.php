        ...
        return [
            ...
            MenuFactory::item(
                ...
                routes: [
                    ...
                    RouteEnum::CONTENT_VIDEO_CATEGORY_INDEX->value,
                    'content_admin_video_category_new',
                    'content_admin_video_category_edit',
                ...
                children: [
                    ...
                    MenuFactory::item(
                        label: 'Catégories de vidéos',
                        routes: [RouteEnum::CONTENT_VIDEO_CATEGORY_INDEX->value, 'content_admin_video_category_new', 'content_admin_video_category_edit'],
                        roles: [],
                        link: RouteEnum::CONTENT_VIDEO_CATEGORY_INDEX->value,
                        permission: 'CONTENT_VIDEO_CATEGORY_VIEW',
                        order: 2,
                    ),
                    MenuFactory::item(
