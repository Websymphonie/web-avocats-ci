...
final class DemoFixturesIntegrityTest extends WebTestCase
{
    ...
    public function testDemoDatasetIsCoherentAndDeterministic(): void
    {
        ...
        self::assertSame(9, $entityManager->getRepository(PageEntity::class)->count([]));
        ...
        self::assertSame(5, $entityManager->getRepository(MediaEntity::class)->count([]));
        self::assertSame(0, $entityManager->getRepository(BatonnierMandateEntity::class)->count([]));
        ...
        self::assertSame(6, $entityManager->getRepository(PageEntity::class)->count(['status' => PageStatus::PUBLISHED]));
        ...
        self::assertSame(4, $entityManager->getRepository(PageEntity::class)->count(['editorialGroup' => PageGroup::BAR]));
        ...
        self::assertSame(30, $fundPage->getSortOrder());
        ...
        self::assertSame(40, $carpaPage->getSortOrder());
